...
from .views.published_job.published_job import KeywordView, DatasetDetailView, ModelDetailView, ModelCustomView, placeholder_functional_view
...
urlpatterns = [
    ...
    path("model/<int:pk>/", placeholder_functional_view, name="model_detail"),
