...
class pythonProgramOptions:
    ...
    # Here should be dynamical input file, not hardcoded
    def get_input_grid_file(inputfilename=None):
        """
        inputfilename - string, input grid file name e.g. 'Grid_demo.txt'
    ...
    grid_filename = get_input_grid_file()  # grid file name (e.g. 'mygrid.txt')
