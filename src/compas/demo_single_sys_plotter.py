...
def main():
    ...
    axes[0][1].plot(
        df['Time'], df['Radius(1)'] / df['Radius_1/RL'], linestyle='--', alpha=0.5, c='r', label='Roche Radius 1'
    )
    axes[0][1].plot(
        df['Time'], df['Radius(2)'] / df['Radius_2/RL'], linestyle='--', alpha=0.5, c='b', label='Roche Radius 2'
    )
